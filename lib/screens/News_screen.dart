...
class _LongListScreenState extends State<LongListScreen> {
        ...
        content: Column(
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Color.fromARGB(255, 255, 58, 209))),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Color.fromARGB(255, 254, 89, 221))),
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Colors.black)),
                hintText: 'Body'),
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('News'),
        backgroundColor: Color.fromRGBO(255, 21, 255, 1),
      ),
      body: Center(
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 243, 10, 243),
